...
** Chrome
   ...
   As of [2010-09-15 Wed], via [[http://googlechromereleases.blogspot.com/][the Chrome release blog]]:

   | Stable/Beta | [[http://dl.google.com/chrome/install/472.59/chrome_installer.exe][Chrome 6.0.472.59]] |
   | Dev         | [[http://dl.google.com/chrome/install/517.5/chrome_installer.exe][Chrome 7.0.517.5]]  |
