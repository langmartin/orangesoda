...
** Chrome
   ...
   As of [2011-01-19 Wed], via [[http://googlechromereleases.blogspot.com/][the Chrome release blog]]:

   | Dev    | [[http://dl.google.com/chrome/install/634.0/chrome_installer.exe][Chrome 10.0.634.0]]  |
   | Beta   | [[http://dl.google.com/chrome/install/597.67/chrome_installer.exe][Chrome 9.0.597.67]]  |
   | Stable | [[http://dl.google.com/chrome/install/552.334/chrome_installer.exe][Chrome 8.0.552.334]] |
